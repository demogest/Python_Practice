...
class Chef(games.Sprite):
	...
	def __init__(self,y =55,speed=2,odds_change=200):
		super(Chef,self).__init__(image=games.load_image('chef.bmp'),
...
class Pizza(games.Sprite):
	...
	def __init__(self,x ,y =90):
		super(Pizza,self).__init__(image=games.load_image('pizza.bmp'),
		x=x,y=y,
		dy = Pizza.speed)
...
class Pan(games.Sprite):
	...
	def __init__(self):
		super(Pan,self).__init__(image=games.load_image('pan.bmp'),
